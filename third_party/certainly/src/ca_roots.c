/*
 * ca_roots.c — Auto-generated root CA trust anchors
 * Generated on 2026-04-11
 * CAs: Amazon Root CA 1, DigiCert Global Root G2, DigiCert Global Root G3,
 *      Google GTS Root R1, Google GTS Root R2, Google GTS Root R3, Google GTS Root R4,
 *      ISRG Root X1 (Let's Encrypt RSA), ISRG Root X2 (Let's Encrypt ECDSA),
 *      Starfield Services Root G2
 * DO NOT EDIT — regenerate with: brssl ta /tmp/cacerts/*.pem
 */
...
const br_x509_trust_anchor TAs[10] = {
	{
