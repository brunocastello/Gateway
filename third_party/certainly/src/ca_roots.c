 ...
 *   python3 tools/generate_ca_roots.py --out third_party/certainly/src/ca_roots.c
 *
 * Mac OS 9 has no usable system trust store, so this list is the
 * whole of what Gateway will trust. Anchors (29):
...
static const unsigned char TA14_EC_Q[] = {
...
static const unsigned char TA15_EC_Q[] = {
...
static const unsigned char TA18_EC_Q[] = {
...
static const unsigned char TA19_EC_Q[] = {
...
static const unsigned char TA22_EC_Q[] = {
...
static const unsigned char TA24_EC_Q[] = {
...
const br_x509_trust_anchor TAs[29] = {
	{
	...
	},
	{
		...
		BR_X509_TA_CA,
		{
			...
			{ .ec = {
				BR_EC_secp384r1,
				(unsigned char *)TA5_EC_Q, sizeof TA5_EC_Q,
			} }
		}
	},
	{
	...
	},
	{
		...
		BR_X509_TA_CA,
		{
			...
			{ .ec = {
				BR_EC_secp384r1,
				(unsigned char *)TA8_EC_Q, sizeof TA8_EC_Q,
			} }
		}
	},
	{
	...
	},
	{
		...
		BR_X509_TA_CA,
		{
			...
			{ .ec = {
				BR_EC_secp256r1,
				(unsigned char *)TA14_EC_Q, sizeof TA14_EC_Q,
			} }
		}
	},
	{
		...
		BR_X509_TA_CA,
		{
			...
			{ .ec = {
				BR_EC_secp384r1,
				(unsigned char *)TA15_EC_Q, sizeof TA15_EC_Q,
			} }
		}
	},
	{
	...
	},
	{
		...
		BR_X509_TA_CA,
		{
			...
			{ .ec = {
				BR_EC_secp256r1,
				(unsigned char *)TA18_EC_Q, sizeof TA18_EC_Q,
			} }
		}
	},
	{
		...
		BR_X509_TA_CA,
		{
			...
			{ .ec = {
				BR_EC_secp384r1,
				(unsigned char *)TA19_EC_Q, sizeof TA19_EC_Q,
			} }
		}
	},
	{
	...
	},
	{
		...
		BR_X509_TA_CA,
		{
			...
			{ .ec = {
				BR_EC_secp384r1,
				(unsigned char *)TA22_EC_Q, sizeof TA22_EC_Q,
			} }
		}
	},
	{
	...
	},
	{
		...
		BR_X509_TA_CA,
		{
			...
			{ .ec = {
				BR_EC_secp384r1,
				(unsigned char *)TA24_EC_Q, sizeof TA24_EC_Q,
			} }
		}
	},
	{
